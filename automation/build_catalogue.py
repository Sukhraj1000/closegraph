...
'E7':('Test harness, fixtures and technical acceptance','Labelled fixtures, deterministic integration/E2E harness and evidence reports. Each feature owns necessary tests; the coordinator records automated technical acceptance. User review is optional.',['1.2','10.1','10.2','10.3','10.4'])}
TITLES={
...
'10.1':'Run the complete backend verification matrix','10.2':'Exercise the real browser correction-to-download journey','10.3':'Produce source-linked MVP acceptance evidence','10.4':'Record automated technical acceptance of the working MVP'}
DEPS={
...
'A03':('Enforce scope, review feedback and appropriate integration tests','Engineering repairs the same PR after changes requested. Reviewer independently reads issue/spec/diff and runs relevant tests; adds integration/E2E requirements only where changed boundaries/journeys need them. Verify current head/base, independent agent review evidence without requiring a distinct GitHub approving account, no duplicate jobs or phase-2 expansion. The coordinator integrates and records technical acceptance without a human approval gate.',['automation/prompts/engineer.md','automation/prompts/reviewer.md','docs/engineering/architecture.md'],['A01','A02']),
