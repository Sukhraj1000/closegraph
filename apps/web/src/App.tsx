...
import { ReconciliationWorkspace } from './features/reconciliation/Workspace';
...
export default function App(){
 ...
 return <ReconciliationWorkspace key={session.csrf_token} session={session} notice={notice} onSessionChange={()=>void refreshIdentity()} onLogout={()=>void api.logout().then(()=>setSession(null)).catch(()=>refreshIdentity())}/>;
}
