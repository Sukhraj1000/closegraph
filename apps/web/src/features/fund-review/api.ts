...
export interface FindingEvidence {dataset_id?:string;source_id?:string;document_id?:string;row_id?:string;column?:string;column_key?:string;raw_value?:unknown;effective_value?:unknown;original_raw_value?:unknown;original_value_available?:boolean;correction?:{actor_id?:string;reason?:string}|null;locator?:Record<string,unknown>}
...
export interface AffectedRecord extends FindingEvidence {source_name:string;columns:Column[];values:Record<string,unknown>;original_values?:Record<string,unknown>;corrections?:Record<string,{actor_id?:string;reason?:string}>}
