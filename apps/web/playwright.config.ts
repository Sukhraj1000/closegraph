...
export default defineConfig({
 ...
 projects:[{name:'batman',testMatch:'batman.spec.ts'},{name:'role-smoke',testMatch:'role-smoke.spec.ts'},{name:'demo-polish',testMatch:'demo-polish.spec.ts'},{name:'fund-review',testMatch:'fund-review.spec.ts'},{name:'reconciliation',testMatch:'reconciliation.spec.ts'},{name:'stories',testMatch:'stories.spec.ts'},{name:'native',testMatch:'native-journey.spec.ts'},{name:'pdf',testMatch:'native-pdf.spec.ts'},{name:'collections',testMatch:'collections.spec.ts'}],
});
